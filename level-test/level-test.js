...
const lv2Questions = [
  ...
  // Q23 - 비교급 (위치: 10번)
  { type:"mc", ko:"'서울은 창원보다 더 커.'를 영어로 하면?", options:[
    "Seoul is more bigger than Changwon.",
    "Seoul is bigger than Changwon.",
    "Seoul is big than Changwon.",
    "Seoul is the biggest than Changwon."
...
function generateResultImage({ p1, p2, p3, p4, pct, recommendation }) {
  ...
  ctx.fillText("Changwon English Community — Level Test", W / 2, 130);
  ...
  ctx.textAlign = "center";
  ctx.fillText("THE BOX 창원 · 상남동", W / 2, 930);

  ctx.font = "500 22px 'Pretendard', 'Noto Sans KR', sans-serif";
  ctx.fillStyle = "rgba(255,255,255,0.4)";
  ctx.fillText("@thebox_changwon | 창원 상남동 | THE BOX 영어 커뮤니티", W / 2, 970);
  ...
  modal.innerHTML = `
    ...
    ">
      ...
      <div style="display: flex; flex-direction: column; gap: 10px;">
        ...
        ` : `
        <a href="../consultation/index.html" class="lv-btn" style="background: ${color}; color: white; text-decoration: none;">
          <span style="display:flex;align-items:center;justify-content:center;width:32px;height:32px;background:rgba(255,255,255,0.25);border-radius:8px;flex-shrink:0;">
        ...
        <a href="../academy/index.html" class="lv-btn" style="background: #F0FDF4; color: #059669; border: 1.5px solid #A7F3D0; text-decoration: none;">
